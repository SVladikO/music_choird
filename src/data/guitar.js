const guitarData = [
    {
        name: 'A', chords: [/** */
            ...
            {name: 'A5', notes: [[6], [], [4, 5], [],], headerNotes: [1, 3, 5], ladNumber: 5},
    ...
    },
    {
        name: 'B', chords: [
            ...
            {name: 'B5', notes: [[5], [], [3, 4], []], headerNotes: [1, 3, 11]},
    ...
    },
    {
        name: 'C', chords: [
            ...
            {name: 'C5', notes: [[2], [], [], [],], headerNotes: [1, 7, 9, 11]},
    ...
    },
    {
        name: 'D', chords: [
            ...
            {name: 'D5', notes: [[], [3], [2], [],], headerNotes: [1, 8, 9, 11]},
    ...
    },
    {
        name: 'G', chords: [
            ...
            {name: 'G5', notes: [[6], [], [4, 5], [],],  ladNumber: 3, headerNotes: [1, 3, 5],},
